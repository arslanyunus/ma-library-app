<template>
    <div class="flex flex-wrap">
        ...
        <div v-if="storeLibrary.booksLoaded" class="flex justify-between w-10/12">
            <span class=" font-medium text-3xl mt-5 mt-10 ml-12">Books</span>
            <a-button class = "mt-14" title="Add Book"
                      type="primary"
                      @click="showAddDrawer"
            >
                <template #icon>
